...
**Definition** A *probability mass function* evaluated at a value corresponds to the probability that a random variable takes that value. To be a valid *pmf* function, $p$ must satisfy:  
